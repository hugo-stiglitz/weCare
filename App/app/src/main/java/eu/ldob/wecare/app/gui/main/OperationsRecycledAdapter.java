...
public class OperationsRecycledAdapter extends RecyclerView.Adapter<OperationsRecycledAdapter.ViewHolder> {

    private List<Operation> operations;

    public OperationsRecycledAdapter(List<Operation> operations) {
    ...
    @Override
    public OperationsRecycledAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(OperationsRecycledAdapter.ViewHolder viewHolder, int position) {
